...
/********************************************************************
* 名称 :voidtime_set(char hour, char min)
* 功能 : 设置时间
...
/********************************************************************
* 名称 :voidTM1637_write1Bit(unsigned char mBit )
* 功能 : 写1bit
...
/********************************************************************
* 名称 :voidTM1637_write1Byte(unsigned char mByte)
* 功能 : 写1byte
...
/********************************************************************
* 名称 :voidTM1637_writeCammand(unsigned char mData)
* 功能 : 写指令1byte
...
/********************************************************************
* 名称 :voidTM1637_writeData(unsigned char addr, unsigned char mData)
* 功能 : 固定地址写数据1byte
